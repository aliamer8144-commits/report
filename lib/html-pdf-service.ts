...
const cellBase = `height:14.8mm;padding:0 3mm;border:0.5mm solid #E0E0E0;font-size:13.5pt;line-height:1.4;display:flex;align-items:center;justify-content:center;box-sizing:border-box;`
