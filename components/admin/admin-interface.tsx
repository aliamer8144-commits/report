...
const tabs = [
  ...
  { id: "users", label: "المستخدمين", icon: UsersRound },
        ...
        <div className="container max-w-md mx-auto p-4">
          ...
          >
            <div className="flex items-center gap-3">
              <Avatar className="h-12 w-12 bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg">
                <AvatarFallback>{getInitials(username || "مدير")}</AvatarFallback>
              </Avatar>
              <div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                  مرحباً
                </h1>
                <p className="text-gray-600">{username || "المدير"}</p>
              </div>
            </div>
          ...
          <AnimatePresence mode="wait">
            {activeTab === "home" && (
              ...
              >
                <ComingSoonContent description="سيتم إنشاء هذه الواجهة قريباً لتوفير تجربة أفضل لإدارة المدير" />
              </motion.div>
            )}
            {activeTab === "reports" && (
              <motion.div
            ...
            {activeTab === "users" && (
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <ComingSoonContent description="سيتم إنشاء هذه الواجهة قريباً لتوفير تجربة أفضل لإدارة المستخدمين" />
              </motion.div>
            )}
            {activeTab === "clients" && (
              <motion.div
